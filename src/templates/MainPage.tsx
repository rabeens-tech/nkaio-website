...
const Identity = () =>{
    return  <main id="services" className="mx-auto flex min-h-[calc(100svh-68px)] max-w-6xl flex-col items-center justify-center px-6 pb-20 pt-12 text-center sm:px-10">
